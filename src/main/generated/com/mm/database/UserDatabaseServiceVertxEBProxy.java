...
public class UserDatabaseServiceVertxEBProxy implements UserDatabaseService {
  ...
  public UserDatabaseServiceVertxEBProxy(Vertx vertx, String address) {
    this(vertx, address, null);
  }

  public UserDatabaseServiceVertxEBProxy(Vertx vertx, String address, DeliveryOptions options) {
    this._vertx = vertx;
  ...
  public UserDatabaseService getUserByNameAndPass(String username, String password, Handler<AsyncResult<JsonObject>> resultHandler) {
    ...
    _deliveryOptions.addHeader("action", "getUserByNameAndPass");
  ...
  public UserDatabaseService getAllUser(Handler<AsyncResult<List<JsonObject>>> resultHandler) {
    ...
    JsonObject _json = new JsonObject();
    DeliveryOptions _deliveryOptions = (_options != null) ? new DeliveryOptions(_options) : new DeliveryOptions();
    _deliveryOptions.addHeader("action", "getAllUser");
